...
Slice Neighbors (current): selecting a node highlights its direct imports/importers and lists them as clickable rows in the sidebar — traversal from any starting point, no re-layout. ✅
